...
import define2 from "./1ea380bf05fbf68c@327.js";
...
This stream transform is an attempt to guard against these errors, and to fix them. It will change the winding order (in other words, rewind) all the polygonal coordinates that trigger one of the following rules:
